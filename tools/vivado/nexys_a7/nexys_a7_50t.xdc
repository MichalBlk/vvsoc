...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { QSPI_WPN }]; #IO_L2P_T0_D02_14 Sch=qspi_dq[2]
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { QSPI_RESETN }]; #IO_L2N_T0_D03_14 Sch=qspi_dq[3]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { QSPI_CSN }]; #IO_L6P_T0_FCS_B_14 Sch=qspi_csn

set_false_path -from [get_clocks -of_objects [get_pins TOP/MAIN_MEMORY/DRAM/MIG/u_mig_mig/u_ddr2_infrastructure/gen_mmcm.mmcm_i/CLKFBOUT]] -to [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]]
set_false_path -from [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins TOP/MAIN_MEMORY/DRAM/MIG/u_mig_mig/u_ddr2_infrastructure/gen_mmcm.mmcm_i/CLKFBOUT]]

set_false_path -from [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT2]]
set_false_path -from [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT2]] -to [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]]

set_false_path -from [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]] -to [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT3]]
set_false_path -from [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT3]] -to [get_clocks -of_objects [get_pins PLL/inst/mmcm_adv_inst/CLKOUT0]]
